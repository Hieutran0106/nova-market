import React from 'react';import {useParams} from 'react-router-dom';import {reviews} from '../data/store';import {useStore} from '../context/StoreContext';import ProductCard from '../components/ProductCard';import {Heart,Scale,ShoppingCart,Star} from 'lucide-react';
const money=n=>new Intl.NumberFormat('vi-VN').format(n)+'đ';
export default function ProductDetail(){
  const {slug}=useParams();
  const {products, addToCart,toggleWishlist,toggleCompare}=useStore();
